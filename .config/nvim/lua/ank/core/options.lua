...
-- Case-insensitive searching UNLESS \C(case sensitive), \c(case-insensitive) or one or more capital letters in the search term
vim.opt.ignorecase = true -- ignore case when searching :set ic / :set noic
